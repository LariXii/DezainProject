...
document.addEventListener('DOMContentLoaded',function(){
	...
	socket.on('joueur',function(){
		...
		document.getElementById('monMessage').disabled = false;
		enjeu = true;
		overlay.removeEventListener("mousemove", function(e) {
			act(currentCommand.move, e);
		});
		overlay.removeEventListener("mousedown", function(e) {
			act(currentCommand.down, e);
		});
		overlay.removeEventListener("mouseup", function(e) {
			act(currentCommand.up, e);
		});
		overlay.removeEventListener("mouseout", function(e) {
			act(currentCommand.out, e);
		});
